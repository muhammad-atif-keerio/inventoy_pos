...
try {
    ...
    execSync(
        "npx prisma db pull --schema=./prisma/current-schema.prisma --print",
        {
            stdio: "inherit",
        },
    );
    ...
    execSync(
        "npx prisma db push --schema=./prisma/schema-ledger-modified.prisma --preview-feature",
        {
            stdio: "inherit",
        },
    );
    ...
    console.log("\n📌 Next steps:");
    console.log(
        "1. Review any warnings or errors from the schema compatibility test",
    );
    console.log(
        "2. If everything looks good, run: node fix-ledger-connection-safe.js",
    );
    console.log(
        "3. Otherwise, adjust the schema-ledger-modified.prisma file as needed",
    );
}
