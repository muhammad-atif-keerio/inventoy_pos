...
async function testLedgerSystem() {
  ...
  try {
    ...
    try {
      ...
      console.log('This is expected if the database connection failed or tables do not exist');
    ...
    console.log('The application will use mock data in development mode if database connection fails');
  } catch (error) {
