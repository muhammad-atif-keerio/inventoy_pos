...
try {
    ...
    if (
        !envContent.includes("LEDGER_DATABASE_URL") ||
        !envContent.match(/LEDGER_DATABASE_URL="[^"]*schema=ledger/)
    ) {
        ...
        console.log(
            "✅ LEDGER_DATABASE_URL already has schema=ledger parameter",
        );
    }
} catch (error) {
